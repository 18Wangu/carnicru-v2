...
const ResultatPortion: React.FC = () => {
  const searchParams = useSearchParams();
  const nomChien = searchParams.get("nomChien") || "Nom de votre compagnon";
  ...
  const renderPlanCard = (title: string, price: string, imageSrc: string, url: string) => (
        ...
        <div className="flex flex-wrap gap-10 justify-center items-center p-2.5 max-md:max-w-full mt-24">
          ...
          <div className="flex flex-col justify-center items-start self-stretch my-auto min-w-[240px]">
            ...
            <div className="flex flex-col mt-12 text-xl max-md:mt-10">
              ...
              <div className="mt-4 text-[#149A77]">30% d&aposos broyés</div>
              <div className="mt-4 text-[#004339]">10% d&aposabats</div>
            </div>
          </div>
        </div>
      </div>
...
export default ResultatPortion;
